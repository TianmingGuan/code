...
--new update for player2 ai  (used name Paddle:update2)
--change the name to Paddle:update2
--ai not working, rewrite the code
function Paddle:update2(dt, ball)
...
--used chatgpt to find out why the paddle couldn't move. (self:update(dt))
